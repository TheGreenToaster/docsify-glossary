...
describe('Package configuration', () => {
  ...
  it('can handle empty configurations', () => {
    ...
    expect(parsedConfiguration.terminologyHeading).toEqual(DEFAULT_TERM_HEADING);
    expect(parsedConfiguration.glossaryLocation).toEqual(DEFAULT_GLOSSARY_FILE_NAME);
    expect(parsedConfiguration.debug).toEqual(false);
  });
